...
const validateDateFrom = () => {
  ...
  if (inputdate < ddate) {
    tripError2.innerHTML =
      "Enter correct departure date. Date must be a future date.";
    return false;
  }
...
const checkButton = () => {
  ...
  if (Sydney.checked) {
    errorRadio.innerHTML =
      Sydney.value +
      " has a cosomopoliatian feel to it. The food is world-class.";
  } else if (Melbourne.checked) {
    errorRadio.innerHTML =
      Melbourne.value + " has great eateries and a reknown cafe culture.";
  } else if (Brisbane.checked) {
    errorRadio.innerHTML =
      Brisbane.value + " has palm trees, ocean breeze and good times.";
  } else if (Perth.checked) {
    errorRadio.innerHTML =
      Perth.value +
      " the place in Western Australia you should visit at least once.";
  }
  return true;
};
...
const validateDob = () => {
  let age = document.getElementById("contact-dob").value;
  let ageError = document.getElementById("dob-error2");

  if (!(age > 1 && age < 100)) {
    ageError.innerHTML = "The age must be a number between 1 and 100";
    return false;
  }
...
const validateDob2 = () => {
  let age = document.getElementById("contact-dob2").value;
  let ageError = document.getElementById("dob-error3");
...
const validateDob3 = () => {
  let age = document.getElementById("contact-dob3").value;
  let ageError = document.getElementById("dob-error4");
